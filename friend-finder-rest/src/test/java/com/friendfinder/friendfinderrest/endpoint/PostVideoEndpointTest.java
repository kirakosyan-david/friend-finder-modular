...
class PostVideoEndpointTest {
    ...
    @InjectMocks
    private PostVideoEndpoint postVideoEndpoint;
    ...
    void testListByPage() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders.get("/posts/video/page/1")
    ...
    void testAddLike() {
        ...
        ResponseEntity<PostLike> response = postVideoEndpoint.addLike(postLikeDto, currentUser, post);
    ...
    void testAddDislike() {
        ...
        ResponseEntity<PostLike> response = postVideoEndpoint.addDislike(postLikeDto, currentUser, post);
    ...
    void testAddComment() {
        ...
        ResponseEntity<Comment> response = postVideoEndpoint.addComment(comment, currentUser, post);
        assertEquals(HttpStatus.OK, response.getStatusCode());
    }
    ...
    void testDeleteCommentById()  {
        ...
        ResponseEntity<Comment> response = postVideoEndpoint.removeComment(comments.getId());
        assertEquals(HttpStatus.OK, response.getStatusCode());
    }
